  ...
  Widget build(BuildContext context) {
    ...
    Widget containerSection = Container(
      child: Column(
        ...
        children: [
          _buildContainerColumn(color, Icons.call, cancer[0], description[0], 'assets/DCIS-1.jpg' ),
          _buildContainerColumn(color, Icons.security, cancer[1], description[1],'assets/LCIS-1.webp'),
          _buildContainerColumn(color, Icons.share, cancer[2], description[2],'assets/IBCS-1.jpg'),
          _buildContainerColumn(color, Icons.share, cancer[3], description[3],'assets/MBCS-1.jpg'),
          _buildContainerColumn(color, Icons.share, cancer[4], description[4],'assets/PCS-1.jpg'),
          _buildContainerColumn(color, Icons.share, cancer[5], description[5],'assets/TNBS-1.jpg'),
          _buildContainerColumn(color, Icons.share, cancer[6], description[6],'assets/MB-2.jpg'),
        ],
      ),
    );
    return Scaffold(
